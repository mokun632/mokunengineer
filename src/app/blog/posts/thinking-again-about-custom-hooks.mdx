---
title: "Custom Hooksについて、改めて考えてみる"
publishedAt: "2024-08-18"
description: "時々、ただの配列を返しているhooksなどを見かけ違和感を覚え、改めてCustom Hooksとは何のかReactのドキュメントを眺めながら考える。"
---

## Custom Hooks について、改めて考えてみる

### 改めて Custom Hooks とは？

もうそんな事知っているよ、と思われるかもしれませんが、改めて Custom Hooks とは何なのかを考えてみます。
React の[ドキュメント](https://ja.react.dev/learn/reusing-logic-with-custom-hooks)には、Custom Hooks について以下のように記載されています。
...
> [!NOTE]
> これは、Suspense にも言える事です。
> 再レンダリングで Suspend が起きるよう再レンダリングを起こしても、fallback は表示されません。
> 同じように、再レンダリングが起きる度に、異なる key を挿入する事で、再度 Suspend を起こす事ができます。
> [ref](https://ja.react.dev/reference/react/Suspense#resetting-suspense-boundaries-on-navigation) > [ref 2](https://x.com/asidorenko_/status/1712523853207847241)
